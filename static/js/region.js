...
$(document).ready(function(){
    ...
    $("#region-span").text(toTitleCase(region));
    ...
    function drawLineChart(freq_per_day){
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('region-chart-div'));

        chart.draw(data, options);
        $("#loader-wrapper").fadeOut();
    }

    // ajax to get necessary data to show stats
    function show_stats(){
